...
Merge2.to_csv("C:/Users/saketha lakshmi/Documents/IEOR242/Project/DataSets/MergedData_214.csv")

#### Just the business star and the average review star
Star = Merge2[['business_id','stars_x', 'stars_y']]
Star.to_csv("C:/Users/saketha lakshmi/Documents/IEOR242/Project/DataSets/Star.csv")

#########RData drop few columns ##############
RData_V1 = RData[['business_id','cool','date','funny','review_id','stars','type','useful','user_id']]
RData_V1.to_csv("C:/Users/saketha lakshmi/Documents/IEOR242/Project/DataSets/Review_wotext.csv")
