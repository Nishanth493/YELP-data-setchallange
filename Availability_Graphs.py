...
Merge2 = pd.read_csv("C:/Users/Nishanth/Documents/IEOR242/Project/DataSets/MergedData_214.csv")
...
Att.to_csv("C:/Users/Nishanth/Documents/IEOR242/Project/DataSets/Merge_DataAvail.csv")
...
for name in col_names:
    ...
    Att_list = Att_list + [avail]
    Att = pd.concat([Att, pd.DataFrame(Att_list).transpose()], axis = 0)
Att.to_csv("C:/Users/Nishanth/Documents/IEOR242/Project/DataSets/Attr_Avail.csv")
...
for name in col_names:
    ...
    Att_list = Att_list + [avail]
    Att = pd.concat([Att, pd.DataFrame(Att_list).transpose()], axis = 0)
Att.to_csv("C:/Users/Nishanth/Documents/IEOR242/Project/DataSets/Cat_Avail.csv")
...
for name in col_names:
    ...
    Att_list = Att_list + [avail]
    Att = pd.concat([Att, pd.DataFrame(Att_list).transpose()], axis = 0)
Att.to_csv("C:/Users/Nishanth/Documents/IEOR242/Project/DataSets/Time_Avail.csv")
